module.exports = function(pool){
	...
	pool.query("DROP TABLE IF EXISTS cursos;\
			...
			insert into cursos values(DEFAULT, 3,'75.04','Algoritmos y Programacion III','12345','PC;PC','400;400',50,0,0,'lunes;miercoles','18:00-21:00;19:00-22:00');\
			insert into cursos values(DEFAULT, 2,'75.73','Arquitectura de Software','12345','PC;PC','400;400',50,0,0,'lunes;miercoles','18:00-21:00;19:00-22:00');\
			\
			");
